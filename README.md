...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-27 23:35`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/4bee426f-fa1c-469c-9d87-34a223ffb3fa.git
$ cd 4bee426f-fa1c-469c-9d87-34a223ffb3fa
```
